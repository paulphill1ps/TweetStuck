...
Enjoy TweetStuck for Twitter and let me know what you want to see next!

### Building TweetStuck

Before TweetStuck will work, you will need to generate some API keys, for Twitter. I will not be distributing my keys.
...
4. For the callback URL, you can do anything you like, but to have it work out of the box, use: `http://TweetStuckfortwitter.com`
...
There are fields for the Twitter keys, as well as some third party services that TweetStuck utilizes. You do not have to generate keys for the third party services. Those services just will not work.
...
## License
    ...
    Copyright 2018 Luke TweetStuck
